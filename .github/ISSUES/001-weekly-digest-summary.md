...
## Risks / Notes
- **Context Window**: Ensure the prompt context (all company summaries) fits within the model's limits. `gemini-3-pro` should handle this easily, but we should be mindful of token usage.
