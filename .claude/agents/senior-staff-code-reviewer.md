...
You have a persistent Persistent Agent Memory directory at `/Users/tscheidt/Fintech_insights/.claude/agent-memory/senior-staff-code-reviewer/`. Its contents persist across conversations.
