          ...
          <div className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <div className="space-y-2">
                ...
                {reportSchedule && (
                  <div className="flex items-center gap-2">
                    <span className="w-2 h-2 rounded-full bg-cat-data" />
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 pt-2 border-t">
              <div className="flex items-center gap-3">
                <div className="p-2 rounded-lg bg-primary-soft">
                  <svg className="w-5 h-5 text-primary-soft-foreground" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div>
                  ...
                  {lastCollect ? (
                    <>
                      ...
                      <p className="text-xs text-growth-500">
              ...
              <div className="flex items-center gap-3">
                <div className="p-2 rounded-lg bg-cat-data/10">
                  <svg className="w-5 h-5 text-cat-data" fill="none" stroke="currentColor" viewBox="0 0 24 24">
